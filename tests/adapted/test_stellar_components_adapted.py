...
from tests.fixtures.stellar_component_fixtures import (
    ComponentTestHelpers, SecurityLevel, SecurityConfig
)
        ...
        with patch('aiohttp.ClientSession.get') as mock_get:
            ...
            try:
                ...
                await metrics_collector.record_metric(
                    ...
                    value=health_value,
                    labels={'test': 'adapted_integration'}
                )
...
class TestPerformanceAdapted:
    ...
    @pytest.mark.asyncio
    async def test_component_initialization_performance_adapted(self, prometheus_registry, security_config, temp_keystore_path):
        ...
        try:
            with patch('hummingbot.connector.exchange.stellar.stellar_health_monitor.get_stellar_logger'), \
        ...
        try:
            with patch('hummingbot.connector.exchange.stellar.stellar_metrics.get_stellar_logger'):
                ...
                metrics = StellarMetrics(registry=prometheus_registry)
