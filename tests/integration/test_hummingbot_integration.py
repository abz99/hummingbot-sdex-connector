...
class TestWebAssistantsFactoryIntegration:
    ...
    async def test_web_assistants_factory_initialization(self, stellar_connector):
        ...
        try:
            ...
            assert (
                factory.throttler is stellar_connector._throttler
            ), "Factory throttler not connected to connector throttler"
...
class TestOrderManagementIntegration:
    ...
    async def test_order_cancellation_integration(self, stellar_connector):
        ...
        try:
            ...
            print("  Non-existent order cancellation handled correctly")
    ...
    async def test_order_status_integration(self, stellar_connector):
        ...
        try:
            ...
            print("  Order status retrieval handled correctly")
...
class TestObservabilityIntegration:
    ...
    async def test_metrics_integration(self, stellar_connector):
        ...
        try:
            ...
            required_fields = [
                "ready",
                "chain_interface_ready",
                "security_framework_ready",
                "order_manager_ready",
                "asset_manager_ready",
                "observability_ready",
            ]
