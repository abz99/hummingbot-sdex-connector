...
from .stellar_throttler import StellarThrottler, StellarAPIEndpoint, create_stellar_throttler
...
class StellarRESTAssistant:
    ...
    def _map_url_to_endpoint(self, url: str) -> Optional[StellarAPIEndpoint]:
        ...
        endpoint_mapping = {
            ...
            'transactions': StellarAPIEndpoint.SUBMIT_TRANSACTION if parsed.query else StellarAPIEndpoint.TRANSACTION_DETAILS,
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "throttler_healthy": (await self.throttler.health_check())["healthy"] if self.throttler else True
        }
...
class StellarWebAssistantsFactory:
    ...
    async def create_shared_session(self) -> ClientSession:
        ...
        session = ClientSession(
            ...
            timeout=timeout,
            headers={
                "User-Agent": self.endpoint_config.user_agent
            }
        )
...
def create_stellar_web_factory(
    ...
    return StellarWebAssistantsFactory(
