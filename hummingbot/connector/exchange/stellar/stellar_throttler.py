...
class StellarThrottler:
    ...
    def __init__(
        self, rate_limits: Optional[List[RateLimit]] = None, enable_metrics: bool = True
    ) -> None:
    ...
    async def acquire_token(self, endpoint: StellarAPIEndpoint, weight: int = 1) -> None:
        """
        ...
        try:
            ...
            await self._throttler.acquire_token(limit_id=endpoint.value, weight=weight)
    ...
    def _update_metrics(self, endpoint: str, wait_time: float, throttled: bool) -> None:
    ...
    def _record_throttling_event(self, endpoint: str, event_type: str, details: str) -> None:
    ...
    async def acquire_multiple_tokens(self, requests: List[Tuple[StellarAPIEndpoint, int]]) -> None:
        """
    ...
    async def reset_metrics(self) -> None:
        ...
        if self.enable_metrics:
            ...
            self.logger.info("Reset throttler metrics", category=LogCategory.PERFORMANCE)
...
def create_stellar_throttler(
    custom_limits: Optional[List[RateLimit]] = None, enable_metrics: bool = True
) -> StellarThrottler:
    """
    ...
    """
    return StellarThrottler(rate_limits=custom_limits, enable_metrics=enable_metrics)
