...
class ModernAssetManager:
    ...
    async def ensure_trustline(self, account_id: str, asset: Asset, limit: Optional[str] = None) -> bool:
        """
    ...
    async def _load_asset_directories(self) -> None:
        ...
        try:
            ...
            well_known_assets = [
                ...
                ("USDC", "GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQEVFL4NAT4AQH3ZLLFLA5", True, "low", 0.8),
                ("EUR", "GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQEVFL4NAT4AQH3ZLLFLA5", True, "low", 0.7),
            ]
            ...
            await self.observability.log_event(
                "asset_directories_loaded",
                {"loaded_assets": len(well_known_assets)}
            )
            
        except Exception as e:
            await self.observability.log_error(
                "asset_directory_loading_failed",
                e
            )
