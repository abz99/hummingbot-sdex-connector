...
class StellarQAMetricsCollector:
            ...
            if coverage_file.exists():
                ...
                for file_path, file_data in coverage_data.get('files', {}).items():
                    if 'stellar' in file_path:
                        ...
                        modules[module_name] = file_data.get('summary', {}).get('percent_covered', 0.0)
    ...
    async def _get_test_execution_data(self) -> Dict[str, Any]:
        ...
        try:
            ...
            cmd = ['python', '-m', 'pytest', '--json-report', '--json-report-file=test_report.json', 
                   'test/', '--tb=no', '-q']
        ...
        try:
            ...
            if qa_catalogue_file.exists():
                ...
                for category, data in categories.items():
                    compliance_percentage = (data['completed'] / data['total'] * 100) if data['total'] > 0 else 0
